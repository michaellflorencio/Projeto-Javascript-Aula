...
export class Terrestre extends Transporte   { // CLASSE FILHA SUB-CLASSE DE TRANSPORTE

    private _numeroRodas: number
    private _velocidade: number

    constructor(capacidade: number, numeroRodas: number, velocidade: number) {
    super(capacidade) // referencia metodo construtor da classe mãe
    ...
    public visualizar(): void {
        super.visualizar() // super => superclasse mae | transporte chamando o metodo visualizar
